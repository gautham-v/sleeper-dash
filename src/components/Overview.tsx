    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-panel rounded-2xl p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 relative z-10">
            <h3 className="font-bold text-lg text-white tracking-tight">Top Standings</h3>
            <button
        ...
        <div className="glass-panel rounded-2xl p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 relative z-10">
            <h3 className="font-bold text-lg text-white tracking-tight">Power Rankings</h3>
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-panel rounded-2xl p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 relative z-10">
            <h3 className="font-bold text-lg text-white tracking-tight">Recent Trades</h3>
            <button
        ...
        <div className="glass-panel rounded-2xl p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 relative z-10">
            <h3 className="font-bold text-lg text-white tracking-tight">Biggest Blowout</h3>
            <button
